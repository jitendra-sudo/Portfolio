...
<>
  ...
  <div className="projectcss">
    ...
    <h2>Project 1 : EasyRent</h2>
    <div className='repo'>
    <a href="https://easyrenter.netlify.app" target="_blank" ><img src='https://img.icons8.com/?size=100&id=B3YslypXlynV&format=png&color=000000' alt='Link'/></a>
    <a href="https://github.com/jitendra-sudo/EasyRent" target="_blank" ><img src='https://img.icons8.com/?size=100&id=12599&format=png&color=000000' alt='Link'/></a>
    </div>
    </div>
    <div className='ProjectImg'>
      <img src={Project7} alt='Project shot'/>
      <img src={Project8} alt='Project shot'/>
      <img src={Project9} alt='Project shot'/>
    </div>
    <div className='descrip'>
    <h4 className='descSection'>Description:</h4>
    <p className='description'>EasyRent: The Tenant-Landlord Communication Platform is designed to streamline communication and manage maintenance requests and rent payments between tenants and landlords</p>
   </div>
    </div>

    <div className="project">
    <div className='repoLink'>
    <h2>Project 2 : OwnField</h2>
    <div className='repo'>
    ...
    <div className="project">
    <div className='repoLink'>
    <h2>Project 3 : CalorieScan : Food Calorie Scanner</h2>
    <div className='repo'>
